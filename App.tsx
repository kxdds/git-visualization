...
import { simulateGitCommand } from './services/geminiService';
...
const App: React.FC = () => {
  ...
  const handleCommand = useCallback(async (commandStr: string) => {
    ...
    // Simulate Command via Gemini
    const result = await simulateGitCommand(gitState, commandStr, language);
    ...
    <div className="flex h-screen w-screen bg-slate-950 text-slate-200 overflow-hidden font-sans">
      ...
      <main className="flex-1 flex flex-col relative min-w-0">
        ...
        <div className="flex-1 p-4 overflow-hidden relative bg-slate-950">
          {/* Decorative Background Wallpaper (Transparent Commands) */}
      ...
      {/* Right Panel: Console & Interaction */}
